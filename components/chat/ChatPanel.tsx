...
export const CHIP_GROUPS: ChipGroup[] = [
  ...
  { id: "culture", icon: "🎭", de: "Kultur",                 en: "Culture",
    cats: ["library", "gallery", "cinema", "museum", "attraction", "theater", "zoo"] },
  ...
  { id: "health",  icon: "🩺", de: "Gesundheit",             en: "Health",
    cats: ["pharmacy", "doctors", "hearing_aids", "hospital", "optician",
           "physiotherapist", "rehabilitation", "medical_supply", "veterinary", "dentist"] },
  { id: "shopping", icon: "🛒", de: "Einkauf",               en: "Shopping",
    cats: ["bakery", "clothes", "florist", "books", "chemist", "bicycle",
           "convenience", "butcher", "furniture", "shoes", "supermarket"] },
  { id: "services", icon: "🧾", de: "Alltag & Service",      en: "Everyday Services",
    cats: ["bank", "hairdresser", "post_office", "laundry"] },
