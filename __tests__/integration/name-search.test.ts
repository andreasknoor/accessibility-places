...
describe('Name-search E2E – restaurants in Berlin Mitte (no LLM)', () => {
  it("geocode → OSM → filterByNameHint pipeline returns results", { timeout: 60_000 }, async () => {
    ...
    const params: SearchParams = {
      ...
      filters:    { entrance: false, toilet: false, parking: false, parkingNearby: true, seating: false, onlyVerified: false, acceptUnknown: true, alwaysShowParking: false, alwaysShowToilets: false, openNowOnly: false },
      sources:    { accessibility_cloud: false, osm: true, reisen_fuer_alle: false, ginto: false, acceslibre: false, google_places: false },
    }
