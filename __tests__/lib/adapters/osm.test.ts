...
const BASE_PARAMS: SearchParams = {
  ...
  filters: { entrance: true, toilet: true, parking: true, parkingNearby: true, seating: false, onlyVerified: false, acceptUnknown: false, alwaysShowParking: false, alwaysShowToilets: false, openNowOnly: false },
...
describe("buildOverpassQuery", () => {
  ...
  it("omits wheelchair pre-filter when all accessibility filters are inactive", () => {
    const noFilters = { entrance: false, toilet: false, parking: false, parkingNearby: true, seating: false, acceptUnknown: false, onlyVerified: false, alwaysShowParking: false, alwaysShowToilets: false, openNowOnly: false }
...
describe("fetchOsm", () => {
  ...
  it("boosts entrance weight when check_date:wheelchair is recent", async () => {
    ...
    // base 0.75, boost ×1.2 → 0.9, capped <= 1.0
  ...
  it("does NOT boost when check_date is older than 2 years", async () => {
    ...
    expect(w).toBeCloseTo(0.75, 5) // base weight, no boost
  })
