...
const CATEGORY_HINTS: Record<Category, string[]> = {
  ...
  books:       ["buchhandlung", "buchladen", "buchgeschäft", "bookshop", "book store", "bookstore"],
  ...
  rehabilitation: ["reha-zentrum", "reha zentrum", "rehazentrum", "rehaklinik", "rehabilitation", "rehabilitationszentrum", "rehabilitation center", "rehabilitation centre"],
  ...
  fuel:              ["tankstelle", "petrol station", "gas station", "fuel"],
  shoes:             ["schuhgeschäft", "schuhladen", "schuhhaus", "shoe shop", "shoe store", "shoes"],
  clothes:           ["bekleidungsgeschäft", "kleidungsgeschäft", "modegeschäft", "clothing store", "clothes shop"],
  convenience:       ["kiosk", "spätkauf", "späti", "convenience store"],
  bicycle:           ["fahrradladen", "fahrradgeschäft", "fahrradhändler", "bike shop", "bicycle shop"],
  furniture:         ["möbelgeschäft", "möbelhaus", "furniture store"],
  butcher:           ["metzgerei", "metzger", "fleischerei", "fleischer", "butcher"],
  florist:           ["blumenladen", "blumengeschäft", "florist"],
  laundry:           ["waschsalon", "wäscherei", "laundromat", "laundry"],
  sports_centre:     ["sporthalle", "sportzentrum", "sportstätte", "sports centre", "sports center", "sports complex"],
}

export const ALL_CATEGORIES: Category[] = [
  "cafe","restaurant","bar","pub","biergarten","fast_food",
  "hotel","hostel","apartment","camp_site",
  "museum","theater","cinema","library","gallery","attraction","books",
  "pharmacy","doctors","dentist","veterinary","hospital","rehabilitation",
  "chemist","supermarket","bakery","hairdresser",
  "bank","post_office","zoo",
  "swimming_pool","fitness_centre","playground","park","sports_centre",
  "physiotherapist","medical_supply","hearing_aids","optician",
  "townhall","place_of_worship","railway_station","fuel",
  "shoes","clothes","convenience","bicycle","furniture","butcher","florist","laundry",
]
