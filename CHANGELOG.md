...
|---|---|---|---|
| 2026-09-25 | Einheitliche Darstellung von Ergebnisliste, Detailansicht und Karten-Popups (**v12.31–v12.37**) | Quickstart- und Experten-Modus zeigen einen Ort jetzt in derselben Formensprache statt „wie zwei verschiedene Apps“: gleiche Kriteriensymbole (Tür, sprachneutrales WC-Piktogramm wie auf der Karte, P) mit Status-Plakette, gleiche Urteilstexte, gleiche Buttons. Ergebniskarten sind ganz antippbar und haben einen beschrifteten „Details“-Button; „Zur Karte“ ist die Standardaktion, „Route“ nie (öffnet eine andere App, daher überall mit ↗ markiert). Die Detailansicht ist in beiden Modi dasselbe Layout mit Foto, Urteilskarte und vier gleichrangigen Aktionen (Route, Anrufen, Website, Teilen – Foto und Teilen jetzt auch im Quickstart); im Experten-Modus ersetzt eine Liste mit aufklappbaren Details die horizontal scrollende Tabelle. Karten-Popups zeigen alles auf einen Blick ohne „Mehr“-Schalter. Alle Links, die eine externe Website öffnen, sind einheitlich mit ↗ gekennzeichnet | XL |
| 2026-08-17 | Öffnungszeiten: „Geöffnet"-Anzeige und Filter | Orte zeigen jetzt an, ob sie gerade geöffnet sind — als farbige Kurzangabe in der Ergebnisliste („Geöffnet", „Schließt in 20 Min", „Geschlossen · öffnet morgen 09:00"), in der Detailansicht zusätzlich über den rohen Öffnungszeiten aus OpenStreetMap, und im Quickstart-Modus auf der Detailseite. Neuer Filter „Nur jetzt geöffnete Orte"; Orte ohne hinterlegte Zeiten bleiben dabei bewusst sichtbar, weil die Datenlage stark schwankt (Stichprobe: Berlin ⌀76 %, ländlich ⌀39 % getaggte Öffnungszeiten). Ist keine eindeutige Aussage möglich — keine Angabe, unlesbares Format oder unklare Zeitzone —, wird gar nichts angezeigt statt einer vagen Vermutung. Die Bewertung erfolgt in der Zeitzone des Ortes, nicht der des Geräts. Für die WC-Suche zusätzlich: Öffnungszeiten-Status auf jeder WC-Karte und im Karten-Popup (während der Suche), im Quickstart-Modus geschlossene WCs ans Listenende sortiert statt ausgeblendet, im Experten-Modus derselbe „Nur jetzt geöffnete Orte"-Filter eigens für die WC-Schnellsuche | M |
